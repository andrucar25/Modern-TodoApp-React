      ...
      >
                      ...
                      >
                        {task.state ? (
                          <div
                            className={
                              lightTheme
                                ? "todo__checkbox__light"
                                : "todo__checkbox"
                            }
                            onClick={() => changeStateCheckButton(index)}
                          ></div>
                        ) : (
                          <div
                            className="todo__checkbox__false"
                            onClick={() => changeStateCheckButton(index)}
                          ></div>
                        )}
                        ...
                        {task.state ? (
                          <input
                            ...
                            className={
                              lightTheme ? "task__text__light" : "task__text"
                            }
                            disabled
                          />
                        ) : (
                        ...
                        {activeState || completedState ? null : (
                          <img
                            src={icondelete}
                            className="todo__task__deleteicon"
                            alt="icon"
            ...
            <div className="options__task">
              ...
              <div className="options__main">
                {allState ? (
                  ...
                  <button
                    className={
                      lightTheme ? "options__button__light" : "options__button"
                    }
                    onClick={listAllTasks}
                  >
                    All
                  </button>
                )}
                {activeState ? (
                  <button
                    className="options__button__active"
                    onClick={listActiveTasks}
                    disabled
                  >
                    Active
                  </button>
                  ...
                  <button
                    ...
                    onClick={listActiveTasks}
                    disabled={completedState ? true : false}
                  >
                    Active
                  </button>
                )}
              ...
              <button
                ...
                disabled={activeState || completedState ? true : false}
              >
                Clear completed
              </button>
            </div>
        ...
        {width <= 1023 && (
          <div
            className={
              lightTheme
                ? "options__main_responsive__light"
                : "options__main_responsive"
            }
          >
            {allState ? (
              <button className="options__button__active">All</button>
